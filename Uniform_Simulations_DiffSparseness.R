...
results05sparse<-SimResultsFrame
...
results09sparse<-SimResultsFrame


mean(results005sparse$newmethod)
sd(results005sparse$newmethod)
mean(results005sparse$guido)
sd(results005sparse$guido)




mean(results05sparse$newmethod)
sd(results05sparse$newmethod)
mean(results05sparse$guido)
sd(results05sparse$guido)



mean(results09sparse$newmethod)
sd(results09sparse$newmethod)
mean(results09sparse$guido)
sd(results09sparse$guido)